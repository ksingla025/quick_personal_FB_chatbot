...
FILENAME = './seq2seq-chatbot/data/twitter/fb_chat.txt'
...
def process_data():
    ...
    # save them
    np.save('./seq2seq-chatbot/data/fb_chat/idx_q.npy', idx_q)
    np.save('./seq2seq-chatbot/data/fb_chat/idx_a.npy', idx_a)
    ...
    with open('./seq2seq-chatbot/data/fb_chat/metadata.pkl', 'wb') as f:
